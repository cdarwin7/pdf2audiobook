...
If you've noticed a bug or have a feature request, [make one](https://github.com/cdarwin7/pdf2audiobook/issues/new)! It's generally best if you get confirmation of your bug or approval for your feature request this way before starting to code.

### Fork & create a branch

If this is something you think you can fix, then [fork PDF2AudioBook](https://github.com/cdarwin7/pdf2audiobook/fork) and create a branch with a descriptive name.
...
```bash
git remote add upstream git@github.com:cdarwin7/pdf2audiobook.git
git checkout master
...
Finally, go to GitHub and [make a Pull Request](https://github.com/cdarwin7/pdf2audiobook/compare) :D
